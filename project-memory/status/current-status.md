...
- 8 issues have been extracted and translated locally and published: The Economist `2026-07-18` and `2026-07-11`, The New Yorker `2026-07-20` and `2026-07-13`, The Atlantic `2026-06-02` and `2026-05-02`, and Wired `2026-06-02` and `2026-05-02`.
- The published corpus has 324 translated articles and 10,356 aligned paragraphs, with zero pending articles. The website currently exposes 322 article entries because 2 pure cartoon pages are filtered from the site index while retained in `texts/` for auditability.
- The remote sync worktree on `root@8.219.229.52` has additional uncommitted `2026-07-02` text work from cron: Atlantic `2026-07-02` is 13/13 translated, and Wired `2026-07-02` is 49/57 translated.
...
- On 2026-07-24, the remote cron stopped during Wired `2026-07-02` because `gpt-5.3-codex-spark` hit its usage limit. The Codex message said to try again at `2026-07-29 10:40 AM`; it did not specify a timezone.
