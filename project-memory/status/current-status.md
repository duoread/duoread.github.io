...
- 10 issues have been extracted locally and published to source: The Economist `2026-07-18` and `2026-07-11`, The New Yorker `2026-07-20` and `2026-07-13`, The Atlantic `2026-07-02`, `2026-06-02`, and `2026-05-02`, and Wired `2026-07-02`, `2026-06-02`, and `2026-05-02`.
- The source corpus has 394 articles and 13,798 aligned paragraphs. 386 articles are translated and 8 Wired `2026-07-02` articles remain pending because Codex Spark quota was exhausted mid-run.
- The website currently exposes 384 article entries: 386 translated articles minus 2 pure cartoon pages filtered from the site index while retained in `texts/` for auditability. Pending articles are retained in `texts/` but do not enter `texts/site-index.json` or `public/content/`.
...
- As of 2026-07-24T09:57:11+08:00 Asia/Shanghai, the remote cron has found downloadable Atlantic and Wired `2026-07-02` EPUBs and is no longer limited to their `2026-06-02` issues.
...
- On 2026-07-24, the remote cron stopped during Wired `2026-07-02` because `gpt-5.3-codex-spark` hit its usage limit. The Codex message said to try again at `2026-07-29 10:40 AM`; it did not specify a timezone. Completed translations were published, and the remote crontab line was commented out with a backup at `/root/aicode/runs/multi_language/crontab-before-pause-20260724T100524+0800.txt`.
